...
uint256 hashGenesisBlock("0x363d2e875b69b617417787cb4ffef603f0012c121d20cfcc3aa707eb1706b408");
...
const string strMessageMagic = "tr011coin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    //nSubsidy >>= (nHeight / 840000); // tr011coin: 840k blocks in ~4 years
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
	...
	{
		nTargetTimespan = 60 * 60; // tr011coin: 1 hour
		nTargetSpacing = 60; // tr011coin: 1 minutes
    ...
    // tr011coin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal tr011coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tr011Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0f637646ad0bf176725ad310b239b6aff4aebe14c71de8c484869bcf25170728");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "When China says no, tr011coin says yes!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386770279;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1855113;

        if (fTestNet)
        {
            block.nTime    = 1386736372;
            block.nNonce   = 389573173;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2afc74455f04c57b3e00b328d543277d65fd0e956f7be541c2007cfe18aa6fa5"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // tr011coin: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
